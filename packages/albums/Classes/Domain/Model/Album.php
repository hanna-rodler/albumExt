...
class Album extends \TYPO3\CMS\Extbase\DomainObject\AbstractEntity
{
    ...
    {
        $this->songs = $this->songs ?: new \TYPO3\CMS\Extbase\Persistence\ObjectStorage();
        $this->ratings = $this->ratings ?: new \TYPO3\CMS\Extbase\Persistence\ObjectStorage();
        $this->genres = $this->genres ?: new \TYPO3\CMS\Extbase\Persistence\ObjectStorage();
    }
     ...
     * Removes a Song
     *
     * @param \HannaRodler\Albums\Domain\Model\Song $songToRemove The Song to be removed
     * @return void
     */
     ...
     * Removes a Rating
     *
     * @param \HannaRodler\Albums\Domain\Model\Rating $ratingToRemove The Rating to be removed
     * @return void
     */
     ...
     * Removes a Genre
     *
     * @param \HannaRodler\Albums\Domain\Model\Genre $genreToRemove The Genre to be removed
     * @return void
     */
